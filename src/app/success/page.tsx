  ...
  return (
    <Suspense
      fallback={
        <div className="min-h-dvh">
          <div className="mx-auto max-w-4xl px-4 py-10 sm:py-14">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-5 text-white/70 shadow-[0_1px_0_0_rgba(255,255,255,0.06)_inset] backdrop-blur">
              {successUi.en.generating}
            </div>
          </div>
        </div>
      }
