...
function plMonthlyOutline(
  ...
  return [
    ...
    ``,
    `## Ogólna energia · te trzydzieści dni`,
    ...
    ``,
    `## Relacje i serce · ${fw.monthly.start}–${fw.monthly.end}`,
    ...
    ``,
    `## Praca, pieniądze, realizacja · ${fw.monthly.start}–${fw.monthly.end}`,
...
function enMonthlyOutline(
  ...
  return [
    ...
    ``,
    `## Your chart backdrop · this window`,
    ...cc.map((l) => `- ${l}`),
    ...
    ``,
    `## Overall energy · these thirty days`,
    ...
    ``,
    `## Relationships & heart · ${fw.monthly.start}–${fw.monthly.end}`,
    ...
    ``,
    `## Work, money & follow-through · ${fw.monthly.start}–${fw.monthly.end}`,
...
function enWeeklyOutline(
  ...
  return [
    ...
    ``,
    `## Your chart backdrop · this week`,
    ...cc.map((l) => `- ${l}`),
    `- One prose sentence linking the chart to this week.`,
    ``,
    `## Overall tone · these seven days`,
    ...
    `## Love & relationships · this week`,
    `- One short paragraph.`,
    ``,
    `## Work & projects · same date range`,
    `- One short paragraph.`,
    ``,
    `## Energy & wellbeing · no medical advice`,
    `- One short paragraph; no medical advice.`,
    ``,
    `## Strongest day · justified from the chart`,
    `- Name the day with YYYY-MM-DD (${fw.timezone}) and justify.`,
    ``,
    `## Challenge · constructive read from the chart`,
...
function esMonthlyOutline(
  ...
  return [
    ...
    ``,
    `## Energía general · estos treinta días`,
    ...
    ``,
    `## Relaciones y corazón · ${fw.monthly.start}–${fw.monthly.end}`,
...
function esWeeklyOutline(
  ...
  return [
    ...
    ``,
    `## Tu carta como telón de fondo · esta semana`,
    ...cc.map((l) => `- ${l}`),
    `- Una frase en prosa: cómo esta carta enmarca esta semana.`,
    ``,
    `## Tono general · estos siete días`,
    ...
    `## Amor y relaciones · esta semana`,
    `- Un párrafo corto.`,
    ``,
    `## Trabajo y proyectos · mismo rango de fechas`,
    `- Un párrafo corto.`,
    ``,
    `## Energía y bienestar · sin consejos médicos`,
    `- Un párrafo corto; sin consejos médicos.`,
    ``,
    `## Día más potente · con justificación en la carta`,
    `- Día con fecha YYYY-MM-DD (${fw.timezone}) y justificación.`,
    ``,
    `## Reto · lectura constructiva`,
    `- Un párrafo constructivo.`,
    ``,
    `## Pregunta para reflexionar · personal`,
...
function natalBasicFreeOutline(
  ...
  if (lang === "pl") {
    return [
      ...
      ``,
      `Potem — wyłącznie trzy nagłówki ## w tej kolejności (styl jak w raporcie osobowościowym — tytuł · podtytuł):`,
      ``,
      `## Słońce · rdzeń ekspresji i motywacji`,
      ...
      ``,
      `## Księżyc · potrzeby i reakcje emocjonalne`,
      ...
      ``,
      `## Ascendent · spotkanie ze światem`,
      birthTimeUnknown
  ...
  if (lang === "es") {
    return [
      ...
      ``,
      `Después, SOLO tres encabezados ## en este orden (estilo como el informe de personalidad: título · subtítulo corto):`,
      ``,
      `## Sol · núcleo motivacional y presencia`,
      ...
      ``,
      `## Luna · necesidades e instinto emocional`,
  ...
  return [
    ...
    ``,
    `Then add ONLY these three ## headings in this order (same pattern as the personality report: Title · subtitle):`,
    ``,
    `## Sun · core drive and visible self`,
    ...
    ``,
    `## Moon · emotional needs and inner climate`,
    ...
    ``,
    `## Ascendant · how you step into the world`,
    birthTimeUnknown
